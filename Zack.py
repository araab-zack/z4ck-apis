...
bot_token = '7370742718:AAF8xw1XmYkkn16TgSV6FHpWOIZSCA509gw'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['991412120']
admin_id = '991412120'
subscription_data = {}
...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'اهلا بك في بوت الرفع الخارجي المطور @LordMorii , شرح البوت تابعه قبل لا تبدء في قناه السورس @MoriSource', reply_markup=keyboard)
    else:
        bot.reply_to(message, 'انت غير مشترك في البوت للاشتراك في البوت : @LordMorii ')
...
def show_admin_commands(message):
    if str(message.from_user.id) == '991412120':  
